...
Enter in ros2 workspace and, before building the packages, extract the individual packages from the Homework_1 folder. Then, build the desired packages using `colcon build` and select the required packages:
```sh
